          ...
          child: Padding(
            ...
            child: Row(
              ...
              Column(
                ...
                Text('View Details',style: AppStyles.stylesemiBold18(context).copyWith(fontSize: 12),),
              ],),
              Spacer(),
              SizedBox(
                width: MediaQuery.sizeOf(context).width*0.6,
                child: CustomButon(text: 'Proceed to Payment', onTap: (){},color: AppColors.primaryColor,  
                ),
              )
            ],),
          ),
