  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      Container(
        ...
        child: Image.asset(Assets.imagesEntryPhoto,fit: BoxFit.cover,),
      ),
      Positioned(
        left: 0,
        right: 0,
      ...
      Positioned(
        ...
        child: Text('Find it here, buy it now!',
          textAlign: TextAlign.center,
        style: AppStyles.stylesRegular14(context).copyWith(color: Color(0xffF2F2F2)),)),
      Positioned(
        left: 0,
        right: 0,
        ...
        child: Padding(
          ...
          child: CustomButon(text:'Get Started',onTap: (){},color: AppColors.primaryColor,),
        )),
    ],);
  }
}
